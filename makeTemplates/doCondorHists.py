...
plotList = [#distribution name as defined in "doHists.py"
        ...
        #'nJet',#:('nJet',linspace(0,20,21).tolist(),';full nJet'),
        #'MET_SumEt',#:('MET_SumEt',linspace(0,1000,51).tolist(),'; scalar sum ET (GeV)'),
        #'RawMET_SumEt',#:('RawMET_SumEt',linspace(0,1000,51).tolist(),'; raw scalar sum ET (GeV)'),
        #'MET_SumPtUnclustered',#:('MET_SumPtUnclustered',linspace(0,1000,51).tolist(),'; scalar sum unclustered pT (GeV)'),
        #'NPV',
