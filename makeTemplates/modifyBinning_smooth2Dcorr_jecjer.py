...
if '2016APV' in templateDir:
    rfiles = [f'{templateDir}/templates_BpMass_ABCDnn_138fbfb_2016APV.root']
    year = '2016APV'
elif '2016' in	templateDir:
    rfiles = [f'{templateDir}/templates_BpMass_ABCDnn_138fbfb_2016.root']
    year = '2016'
elif '2017' in  templateDir:
    rfiles = [f'{templateDir}/templates_BpMass_ABCDnn_138fbfb_2017.root']
    year = '2017'
...
for rfile in rfiles: 
    ...
    outputRfiles[iRfile] = TFile(rfile.replace('.root','_smoothedJJ.root'),'RECREATE')
    ...
    for hist in jecUphists+jerUphists:
        ...
        # unblinding
        #210
        frac = 0.05 # 0.1 causes a spike in jec2016
        ...
        #105 #AN-v7
        # frac = 0.07
        # if 'jec2018' in hist and 'Wjet' in hist:
        #     frac = 0.08
        # if 'jec2018' in hist and 'untagTlep' in hist:
        #     frac = 0.08
        # if 'jec2016APV' in hist and 'Tjet' in hist:
        #     frac = 0.09
        # if 'jec2017' in hist and 'Wjet' in hist:
        #     frac = 0.09
        # if 'jec2017' in hist and 'Tjet' in hist:
        #     frac = 0.08
        # if 'jec2016APV' in hist and ('Wjet' in hist or 'untagTlep' in hist):
        #     frac = 0.09
        ##if ('jec2016' in hist and 'Tjet' in hist) or ('jer2016' in hist and 'jet' in hist) or ('jec2016APV' in hist and 'Tjet' in hist):
        ##    frac = 0.05
