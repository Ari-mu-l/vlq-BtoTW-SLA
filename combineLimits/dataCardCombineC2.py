...
dateKey = '_Jan2025'
outputdir = 'limits_templates'+saveKey+dateKey+'_RB1_2Dcorr'+dirPostFix+'C2'#+'_largeRateUncert' #.replace('UC4','NoUC')  ## Edit last string for unique identifier. IF CHANGING BINNING, GO CHANGE FILE NAME BELOW!
...
def add_systematics(cb):
	...
	#### Use these rateParams to make a comparison to 2016-only
        ...
        if isABCDnn:
                ...
                cb.cp().process([allbkgs[0]]).channel(chns1).AddSyst(cb, 'abcdRateC2', 'lnN', ch.SystMap()(1.02)) #1.02 #1.15
        ...
        for chn in ['cmb']:
                ...
                for mass in massList:
                        ...
                        for reg in regionlist:
                                cmd += 'Case2_'+reg+'=Bp_isL_tagWjet_'+reg+'_0_Combine.txt '
...
if __name__ == '__main__':
        ...
        chns = [hist[hist.find('fb_')+3:hist.find('__')] for hist in allHistNames if '__'+dataName in hist and 'all' not in hist and 'tagWjet' in hist]
