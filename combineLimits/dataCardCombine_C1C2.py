...
dirPostFix = 'BtargetHoleCorrBTrain_smooth_rebin_dynamicST' #sys.argv[1]
template = 'templates'+region+'_Jan2025_210bins'+dirPostFix
#postfix = 'rebinned1_stat0p2_smoothed_TVJJ'#_UC'
postfix = 'smoothedJJ_rebinned1_stat0p2_smoothedTV_smoothUncert'
saveKey = 'ABCDnn_'+region 
dateKey = '_Jan2025'
if '_smoothUncert' in postfix:
        outputdir = 'limits_templates'+saveKey+dateKey+'_RB1_2Dcorr'+dirPostFix+'_smoothUncert_Boosted'
else:
        outputdir = 'limits_templates'+saveKey+dateKey+'_RB1_2Dcorr'+dirPostFix+'_Boosted' #+'_largeRateUncert' #.replace('UC4','NoUC')  ## Edit last string for unique identifier. IF CHANGING BINNING, GO CHANGE FILE NAME BELOW!
