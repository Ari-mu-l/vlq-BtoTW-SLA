...
os.system('combineTool.py -M AsymptoticLimits -d cmb/*/workspace.root --there -n .limitUB > outputAsymptoticLimits.txt')
...
os.system('combineTool.py -M CollectLimits cmb/*/*.limitUB.* --use-dirs -o limitsUB_cmb.json > outputCollectLimits.txt')
