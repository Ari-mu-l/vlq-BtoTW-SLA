...
# echo "--------------- Working on SR  -------------------"
dir=limits_templatesABCDnn_D_Jan2025_RB1_2DcorrBtargetHoleCorrBTrain_smooth_rebin_800_freezeSignalScale #_largeRateUncert
mass=800
...
python3 -u runImpacts_800_freezeSignalScale.py $dir $mass local 0
