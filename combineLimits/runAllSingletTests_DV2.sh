...
#dir=limits_templatesABCDnn_D_Jan2025_RB1_2DcorrBtargetHoleCorrBTrain_smooth_rebin_dynamicST_clipped_smoothUncert #_JumpExcC2Seg1 #_clip #_JumpAll
#mass=1200
...
dir=limits_templatesABCDnn_DV2_Jan2025_RB1_2DcorrBtargetHoleCorrBTrain_smooth_rebin_dynamicST_clipped_smoothUncert
mass=1200
...
#python3 -u runCondorToys.py inject $dir $mass 1.3828125 500

#mass=1800
#echo "Submitting toys to condor for 1800 R = exp0:"
#python3 -u runCondorToys.py inject $dir $mass 0.3759765625 500

mass=1200
echo "Running impact test: "
python3 -u runImpacts.py $dir $mass local 1.3828125
...
#mass=1200
#python3 -u signalInjectionPlotter.py $dir $mass 1.3828125   # r-value of expected limit

#mass=1800
#python3 -u signalInjectionPlotter.py $dir $mass 0.3759765625   # r-value of expected limit
